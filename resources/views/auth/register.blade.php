...
@section('content')
    <div class="min-h-screen flex items-center justify-center">
        <div class="w-full max-w-md mx-auto p-6">
            <!-- Alert Messages -->
            @if (session('success'))
                <div class="mb-4 p-4 text-sm text-blue-700 bg-green-100 rounded-lg">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl font-bold text-primary">Buat Akun</h2>
                <p class="text-secondary mt-2">Buat akun untuk terus berbelanja</p>
            </div>
            ...
            <div
                ...
                <form class="space-y-6" action="{{ route('auth.register') }}" method="POST">
                    ...
                    <button type="submit" class="w-full py-4 px-6 rounded-xl text-white font-medium" style="background-color:#2b6cb0;">
                        Create Account
                    </button>
                </form>
            </div>
            ...
            <p class="mt-8 text-center text-secondary">
                ...
                <a href="{{ route('login') }}" class="text-accent font-medium hover:text-blue-700" style="color:#2b6cb0;">Sign in</a>
            </p>
        </div>
    </div>
