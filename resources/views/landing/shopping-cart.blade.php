            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-96">
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        @if (auth()->check())
                            <button style="background-color:#2b6cb0;" data-summary="checkout"
                                class="mt-6 w-full bg-blue-700 text-white py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                Proceed to Checkout
                            </button>
                            <button id="payButton"
                                class="mt-6 w-full bg-blue-700 text-white py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" hidden>
                                Pay Now
                            </button>
                        @else
                            <div class="flex flex-col gap-6">
                                <a href="{{ route('login') }}"
                                    class="mt-10 w-full bg-blue-700 text-white py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-center">
                                    Login to Checkout
                                </a>
                            </div>
                        @endif
